...
![DCGAN Basic Architecture Model]({{'../assets/images/team34/model/basic-GAN-arch' | relative_url}})
...
![StyleGAN2-ADA Linear Interpolation GIF]({{'../assets/images/team34/Stylegan/lin-interpolation-gif.mp4' | relative_url}})
