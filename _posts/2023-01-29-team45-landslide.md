...
layout: post
comments: true
title: An Overview of Deep Learning for Curious People (Sample post)
author: Lilian Weng
...
![Artificial neural network]({{ '/assets/images/Lil-Weng/ANN.png' | relative_url }})
...
![Data size versus model performance]({{ '/assets/images/Lil-Weng/data_size_vs_model_performance.png' | relative_url }})
{: style="width: 400px; max-width: 100%;"}
...
![Human visual cortex system]({{ '/assets/images/Lil-Weng/visual_cortex_system.png' | relative_url }})
...
![Architecture of LeNet]({{ '/assets/images/Lil-Weng/lenet.png' | relative_url }})
...
![Recurrent neural network]({{ '/assets/images/Lil-Weng/RNN.png' | relative_url }})
...
![LSTM]({{ '/assets/images/Lil-Weng/LSTM.png' | relative_url }})
...
![Shakespeare by RNN]({{ '/assets/images/Lil-Weng/rnn_shakespeare.png' | relative_url }})
{: style="width: 500px"}
...
![Sequence-to-sequence model]({{ '/assets/images/Lil-Weng/seq2seq_gmail.png' | relative_url }})
{: }
...
![Autoencoder]({{ '/assets/images/Lil-Weng/autoencoder.png' | relative_url }})
...
![Autoencoder experiment]({{ '/assets/images/Lil-Weng/autoencoder_experiment.png' | relative_url }})
...
![AlphaGo paper]({{ '/assets/images/Lil-Weng/alphago_paper.png' | relative_url }})

![AlphaGo model]({{ '/assets/images/Lil-Weng/alphago_model.png' | relative_url }})
...
![Generative adversarial network]({{ '/assets/images/Lil-Weng/GAN.png' | relative_url }})
{: style="width: 600px; max-width: 100%;"}
...
![Deep learning toolkits]({{ '/assets/images/Lil-Weng/deep_learning_toolkits.png' | relative_url }})
...
[0] Merghadi, Abderrahmanea, et al. “Machine Learning Methods for Landslide Susceptibility Studies: A Comparative Overview of Algorithm Performance.” Earth-Science Reviews, Elsevier, 3 June 2020, https://www.sciencedirect.com/science/article/pii/S0012825220302713. 

[1] Korup, O. and Stolle, A. (2014), Landslide prediction from machine learning. Geology Today, 30: 26-33. https://doi.org/10.1111/gto.12034

[2] Marjanović, Miloš et al. “Landslide Susceptibility Assessment Using SVM Machine Learning Algorithm.” Engineering Geology, Elsevier, 19 Sept. 2011, https://www.sciencedirect.com/science/article/pii/S0013795211002195.
